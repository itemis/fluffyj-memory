...
public final class NativeMethodHandle<T> {
    ...
    public static ReturnTypeStage ofLib(SymbolLookup stdlib) {
    ...
    private static final class NativeMethodHandleBuilder<T> implements ReturnTypeStage, FuncStage<T>, ArgsStage<T>, CreateStage<T> {
        ...
        public <K> FuncStage<K> returnType(Class<? super K> returnType) {
            ...
            cReturnType = CLinker.C_LONG_LONG;
        ...
        public CreateStage<T> args(MemoryLayout... args) {
            ...
            methodType = MethodType.methodType(javaReturnType, MemoryAddress.class);
